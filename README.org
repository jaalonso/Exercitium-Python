...
+ X12-10-22 [[./src/aproximacion_del_numero_e.py][Aproximación del número e]].
+ J13-10-22 [[./src/limite_del_seno.py][Aproximación al límite de sen(x)/x cuando x tiende a cero]].
