...
+ 09 [[./src/Maxima_suma_de_caminos_en_un_triangulo.py][Máxima suma de caminos en un triángulo]].
+ 14 [[./src/Numeros_amigos.py][Números amigos]].
+ 19 [[./src/Primos_equidistantes.py][Primos equidistantes]].
+ 24 [[./src/Numeracion_de_ternas.py][Numeración de ternas de naturales]].
+ 29 [[./src/Triangulares_con_cifras.py][Números triangulares con n cifras distintas]].
