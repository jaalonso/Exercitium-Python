...
+ X28 [[./src/BusquedaEnProfundidad.py][Búsqueda en espacios de estados por profundidad]].
+ J29 [[./src/BusquedaEnAnchura.py][Búsqueda en espacios de estados por anchura]].
+ V30 [[./src/BEE_Reinas.py][El problema de las n reinas (mediante espacios de estados)]].
