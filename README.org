...
+ M28 [[./src/Relaciones_binarias.py][Relaciones binarias]].

+ M28? [[./src/Universo_y_grafo_de_una_relacion_binaria.py][Universo y grafo de una relación binaria]].
+ X29? [[./src/Relaciones_reflexivas.py][Relaciones reflexivas]].
