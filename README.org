...
+ L23 [[./src/transformaciones_pilas_listas.py][TAD de las pilas: Transformación entre pilas y listas]].
+ M24 [[./src/filtraPila.py][TAD de las pilas: Filtrado de pilas según una propiedad]].
