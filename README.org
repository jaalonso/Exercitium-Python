...
+ M23 [[./src/TAD/Grafo.py][El tipo abstracto de datos de los grafos]].
+ M23 [[./src/TAD/GrafoConListaDeAdyacencia.py][El TAD de los grafos mediante listas de adyacencia]].
+ X24 [[./src/Grafo_Grafos_completos.py][TAD de los grafos: Grafos_completos]].
+ J25 [[./src/Grafo_Grafos_ciclos.py][TAD de los grafos: Grafos ciclos]].
+ V26 [[./src/Grafo_Numero_de_vertices.py][TAD de los grafos: Número de vértices]].
