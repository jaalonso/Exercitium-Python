...
+ V20 [[./src/TAD/pila.py][El tipo abstracto de datos de las pilas]].
+ V20 [[./src/TAD/pilaConListas.py][El tipo de datos de las pilas mediante listas]].
+ V20 [[./src/TAD/pilaConDeque.py][El tipo de datos de las pilas mediante deque]].
+ L23 [[./src/transformaciones_pilas_listas.py][Transformación entre pilas y listas]].
+ M24 [[./src/filtraPila.py][Filtrado de pilas según una propiedad]].
+ X25 [[./src/mapPila.py][Aplicación de una función a los elementos de una pila]].
+ J26 [[./src/pertenecePila.py][Pertenencia a una pila]].
+ V27 [[./src/contenidaPila.py][Inclusión de pilas]].
+ L30 [[./src/prefijoPila.py][Reconocimiento de prefijos de pilas]].
+ M31 [[./src/subPila.py][Reconocimiento de subpilas]].
+ X01 [[./src/ordenadaPila.py][Reconocimiento de ordenación de pilas]].
+ J02 [[./src/ordenaInserPila.py][Ordenación de pilas por inserción]].
+ V03 [[./src/nubPila.py][Eliminación de repeticiones en una pila]].
+ L06 [[./src/maxPila.py][Máximo elemento de una pila]].
