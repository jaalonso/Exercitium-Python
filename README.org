...
** Febrero
+ 04 [[./src/Primos_cubanos.py][Primos cubanos]].
+ 09 [[./src/Cuadrado_mas_cercano.py][Cuadrado más cercano]].
+ 14 [[./src/Suma_de_cadenas.py][Suma de cadenas]].
+ 19 [[./src/Sistema_factoradico_de_numeracion.py][Sistema factorádico de numeración]].
+ 24 [[./src/Duplicacion_de_cada_elemento.py][Duplicación de cada elemento]].
+ 29 [[./src/Suma_de_fila_del_triangulo_de_los_impares.py][Suma de fila del triángulo de los impares]].
