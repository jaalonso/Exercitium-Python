S#+TITLE: Soluciones de los problemas de Exercitium con Python
...
** Para mayo
+ L01 [[./src/Pol_Comprobacion_de_raices_de_polinomios.py][TAD de los polinomios: Comprobación de raíces de polinomios]].
+ M02 [[./src/Pol_Derivada_de_un_polinomio.py][TAD de los polinomios: Derivada de un polinomio]].
+ X03 [[./src/Pol_Resta_de_polinomios.py][TAD de los polinomios: Resta de polinomios]].
+ J04 [[./src/Pol_Potencia_de_un_polinomio.py][TAD de los polinomios: Potencia de un polinomio]].
+ V05 [[./src/Pol_Integral_de_un_polinomio.py][TAD de los polinomios: Integral de un polinomio]].
+ L08 [[./src/Pol_Integral_definida_de_un_polinomio.py][TAD de los polinomios: Integral definida de un polinomio]].
+ M09 [[./src/Pol_Multiplicacion_de_un_polinomio_por_un_numero.py][TAD de los polinomios: Multiplicación de un polinomio por un número]].
+ X10 [[./src/Pol_Division_de_polinomios.py][TAD de los polinomios: División de polinomios]].
+ J11 [[./src/Pol_Divisibilidad_de_polinomios.py][TAD de los polinomios: Divisibilidad de polinomios]].
+ V12 [[./src/Pol_Metodo_de_Horner_del_valor_de_un_polinomio.py][TAD de los polinomios: Método de Horner del valor de un polinomio]].
