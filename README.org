...
+ 19 [[./src/BEE_El_problema_de_las_fichas.py][El problema de las fichas mediante búsqueda en espacio de estado]].
+ 24 [[./src/El_problema_del_calendario_mediante_busqueda_en_espacio_de_estado.py][El problema del calendario mediante búsqueda en espacio de estado]].
+ 29 [[./src/El_problema_del_domino.py][El problema del dominó]].
+ 04 [[./src/Problema_de_suma_cero.py][Problema de suma cero]].
