...
+ X28 [[./src/arboles_con_bordes_iguales.py][Árboles con bordes iguales]].
+ J29 [[./src/arboles_con_igual_estructura.py][Árboles con igual estructura]].
+ V30 [[./src/existencia_de_elemento_del_arbol_con_propiedad.py][Existencia de elementos del árbol que verifican una propiedad]].
