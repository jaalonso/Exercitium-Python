...
def test_GrafoConListaDeAdyacencia() -> None:
    ...
    assert str(ejGrafoND) == \
        "G ND ([1, 2, 3, 4, 5], [((1, 2), 12), ((1, 3), 34), ((1, 5), 78), ((2, 1), 12), ((2, 4), 55), ((2, 5), 32), ((3, 1), 34), ((3, 4), 61), ((3, 5), 44), ((4, 2), 55), ((4, 3), 61), ((4, 5), 93), ((5, 1), 78), ((5, 2), 32), ((5, 3), 44), ((5, 4), 93)])"
    ...
    assert str(creaGrafo(Orientacion.ND, (1,3), [((1,2),12),((1,3),34)])) == \
        "G ND ([1, 2, 3], [((1, 2), 12), ((1, 3), 34), ((2, 1), 12), ((3, 1), 34)])"
    assert str(creaGrafo(Orientacion.D, (1,3), [((1,2),12),((1,3),34)])) == \
        "G D ([1, 2, 3], [((1, 2), 12), ((1, 3), 34)])"
    assert str(creaGrafo(Orientacion.D, (1,4), [((1,2),12),((1,3),34)])) == \
